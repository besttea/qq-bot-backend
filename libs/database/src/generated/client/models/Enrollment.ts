...
export type EnrollmentWhereInput = {
  ...
  user_id?: Prisma.StringFilter<"Enrollment"> | string
  class_id?: Prisma.StringFilter<"Enrollment"> | string
  joined_at?: Prisma.DateTimeFilter<"Enrollment"> | Date | string
...
export type EnrollmentWhereUniqueInput = Prisma.AtLeast<{
  user_id_class_id?: Prisma.EnrollmentUser_idClass_idCompoundUniqueInput
  AND?: Prisma.EnrollmentWhereInput | Prisma.EnrollmentWhereInput[]
  OR?: Prisma.EnrollmentWhereInput[]
  NOT?: Prisma.EnrollmentWhereInput | Prisma.EnrollmentWhereInput[]
  user_id?: Prisma.StringFilter<"Enrollment"> | string
...
export type EnrollmentScalarWhereWithAggregatesInput = {
  ...
  user_id?: Prisma.StringWithAggregatesFilter<"Enrollment"> | string
  class_id?: Prisma.StringWithAggregatesFilter<"Enrollment"> | string
  joined_at?: Prisma.DateTimeWithAggregatesFilter<"Enrollment"> | Date | string
}
...
export type EnrollmentUser_idClass_idCompoundUniqueInput = {
  user_id: string
  class_id: string
}
...
export type EnrollmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"user_id" | "class_id" | "joined_at", ExtArgs["result"]["enrollment"]>
...
export interface EnrollmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const enrollmentWithUser_idOnly = await prisma.enrollment.findMany({ select: { user_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Enrollments and only return the `user_id`
   * const enrollmentWithUser_idOnly = await prisma.enrollment.createManyAndReturn({
   *   select: { user_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Enrollments and only return the `user_id`
   * const enrollmentWithUser_idOnly = await prisma.enrollment.updateManyAndReturn({
   *   select: { user_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface EnrollmentFieldRefs {
  ...
  readonly joined_at: Prisma.FieldRef<"Enrollment", 'DateTime'>
}
